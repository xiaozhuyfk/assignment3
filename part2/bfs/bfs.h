...
void bfs_step_ref(DistGraphRef &g,
        int *depths,
        DistFrontierRef &current_frontier,
        DistFrontierRef &next_frontier,
        std::set<int> &done_foreign_vertices);
